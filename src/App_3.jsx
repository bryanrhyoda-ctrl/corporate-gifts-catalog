    ...
    <div style={{ fontFamily: "'Inter', system-ui, sans-serif", background: "#f8f8f6", minHeight: "100vh", padding: "0 0 60px" }}>
      ...
      {showPriceTiers && isAdmin && (
        <div style={{ position: "fixed", top: 0, left: 0, right: 0, bottom: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 1000, padding: 20 }}>
          <div style={{ background: "#fff", borderRadius: 12, padding: 32, maxWidth: 600, width: "100%", maxHeight: "85vh", overflowY: "auto", boxShadow: "0 10px 40px rgba(0,0,0,0.2)" }}>
            ...
            <div style={{ marginBottom: 24, padding: 16, background: "#f5f5f5", borderRadius: 8 }}>
              ...
              <input type="text" value={newPriceTierLabel} onChange={e => setNewPriceTierLabel(e.target.value)} placeholder="Label (Budget)" style={{ width: "100%", boxSizing: "border-box", padding: "10px", fontSize: 13, border: "1px solid #ddd", borderRadius: 6, marginBottom: 8, fontFamily: "inherit" }} />
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8, marginBottom: 8 }}>
                <input type="number" value={newPriceTierMin} onChange={e => setNewPriceTierMin(e.target.value)} placeholder="Min" style={{ padding: "10px", fontSize: 13, border: "1px solid #ddd", borderRadius: 6, fontFamily: "inherit" }} />
                <input type="text" value={newPriceTierMax} onChange={e => setNewPriceTierMax(e.target.value)} placeholder="Max (Infinity)" style={{ padding: "10px", fontSize: 13, border: "1px solid #ddd", borderRadius: 6, fontFamily: "inherit" }} />
              </div>
            ...
            {priceTiers.map(pt => (
              <div key={pt.label} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: 12, background: "#f5f5f5", borderRadius: 6, marginBottom: 8 }}>
                <div>
                  <strong>{pt.label}</strong> <span style={{ color: "#999", fontSize: 12 }}>RM{pt.min} – {pt.max === Infinity ? "∞" : "RM" + pt.max}</span>
                </div>
                <div style={{ display: "flex", gap: 6 }}>
                  <button onClick={() => editPriceTier(pt.label)} style={{ padding: "6px 12px", background: "#666", color: "#fff", border: "none", borderRadius: 4, fontSize: 12, fontWeight: 600, cursor: "pointer" }}>✏️ Edit</button>
                  <button onClick={() => deletePriceTier(pt.label)} style={{ padding: "6px 12px", background: "#ff5555", color: "#fff", border: "none", borderRadius: 4, fontSize: 12, fontWeight: 600, cursor: "pointer" }}>🗑️ Delete</button>
                </div>
              </div>
            ))}
          ...
          <div style={{ background: "#fff", borderRadius: 12, padding: 32, maxWidth: 600, width: "100%", maxHeight: "85vh", overflowY: "auto", boxShadow: "0 10px 40px rgba(0,0,0,0.2)" }}>
            ...
            {leadTimes.map(lt => (
              <div key={lt.id} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: 12, background: "#f5f5f5", borderRadius: 6, marginBottom: 8 }}>
                <div>
                  <strong>{lt.label}</strong> <span style={{ color: "#999", fontSize: 12 }}>({lt.sub})</span>
                </div>
                <div style={{ display: "flex", gap: 6 }}>
                  <button onClick={() => editLeadTime(lt.id)} style={{ padding: "6px 12px", background: "#666", color: "#fff", border: "none", borderRadius: 4, fontSize: 12, fontWeight: 600, cursor: "pointer" }}>✏️ Edit</button>
                  <button onClick={() => deleteLeadTime(lt.id)} style={{ padding: "6px 12px", background: "#ff5555", color: "#fff", border: "none", borderRadius: 4, fontSize: 12, fontWeight: 600, cursor: "pointer" }}>🗑️ Delete</button>
                </div>
              </div>
            ))}
          ...
          <div style={{ background: "#fff", borderRadius: 12, padding: 32, maxWidth: 600, width: "100%", maxHeight: "85vh", overflowY: "auto", boxShadow: "0 10px 40px rgba(0,0,0,0.2)" }}>
            ...
            {categories.map(cat => (
              <div key={cat} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: 12, background: "#f5f5f5", borderRadius: 6, marginBottom: 8 }}>
                <strong>{cat}</strong>
                <div style={{ display: "flex", gap: 6 }}>
                  <button onClick={() => editCategory(cat)} style={{ padding: "6px 12px", background: "#666", color: "#fff", border: "none", borderRadius: 4, fontSize: 12, fontWeight: 600, cursor: "pointer" }}>✏️ Edit</button>
                  <button onClick={() => deleteCategory(cat)} style={{ padding: "6px 12px", background: "#ff5555", color: "#fff", border: "none", borderRadius: 4, fontSize: 12, fontWeight: 600, cursor: "pointer" }}>🗑️ Delete</button>
                </div>
              </div>
            ))}
      ...
      <div style={{ background: isAdmin ? "#8b5a1f" : "#1a1a1a", padding: "20px 32px", borderBottom: "3px solid #c8a96e", minHeight: "80px" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div style={{ marginBottom: 12 }}>
            <h1 style={{ margin: 0, fontSize: 28, fontWeight: 700, color: "#fff" }}>Product Catalog</h1>
            <p style={{ margin: "4px 0 0", color: "#aaa", fontSize: 12 }}>🔥 Firebase Database</p>
          </div>
          
          <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
            {isAdmin && (
              <>
                <button onClick={() => setShowLeadTimes(true)} style={{ padding: "10px 16px", background: "#666", color: "#fff", border: "none", borderRadius: 6, fontSize: 12, fontWeight: 600, cursor: "pointer" }}>⏱️ Lead Times</button>
                <button onClick={() => setShowPriceTiers(true)} style={{ padding: "10px 16px", background: "#666", color: "#fff", border: "none", borderRadius: 6, fontSize: 12, fontWeight: 600, cursor: "pointer" }}>💰 Price Tiers</button>
                <button onClick={() => setShowCategories(true)} style={{ padding: "10px 16px", background: "#666", color: "#fff", border: "none", borderRadius: 6, fontSize: 12, fontWeight: 600, cursor: "pointer" }}>📂 Categories</button>
