...
export default function App() {
  ...
  if (loading) {
    return <div style={{ textAlign: "center", padding: "60px 20px", fontSize: 14 }}>Loading...</div>;
  }
  ...
  return (
    <div style={{ fontFamily: "'Inter', system-ui, sans-serif", background: "#f8f8f6", minHeight: "100vh", padding: "0 0 60px" }}>
      ...
      {showLeadTimes && isAdmin && (
        <div style={{ position: "fixed", top: 0, left: 0, right: 0, bottom: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 1000 }}>
          <div style={{ background: "#fff", borderRadius: 12, padding: 32, maxWidth: 500, width: "90%", maxHeight: "80vh", overflowY: "auto", boxShadow: "0 10px 40px rgba(0,0,0,0.2)" }}>
            ...
            <div style={{ marginBottom: 24, padding: 16, background: "#f5f5f5", borderRadius: 8 }}>
              ...
              <input type="text" value={newLeadTimeId} onChange={e => setNewLeadTimeId(e.target.value)} placeholder="ID (e.g., L5)" style={{ width: "100%", boxSizing: "border-box", padding: "10px", fontSize: 13, border: "1px solid #ddd", borderRadius: 6, marginBottom: 8, fontFamily: "inherit" }} />
            ...
            <div style={{ marginBottom: 20 }}>
              ...
              {leadTimes.map(lt => (
                <div key={lt.id} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: 10, background: "#f5f5f5", borderRadius: 6, marginBottom: 8 }}>
                  <div><strong>{lt.label}</strong> ({lt.sub})</div>
                  <button onClick={() => deleteLeadTime(lt.id)} style={{ padding: "5px 10px", background: "#ff5555", color: "#fff", border: "none", borderRadius: 4, fontSize: 12, fontWeight: 600, cursor: "pointer" }}>Delete</button>
                </div>
              ))}
            </div>

            <button onClick={() => setShowLeadTimes(false)} style={{ width: "100%", padding: "10px", background: "#888", color: "#fff", border: "none", borderRadius: 6, fontSize: 13, fontWeight: 600, cursor: "pointer" }}>Close</button>
          </div>
        </div>
      )}
      ...
      {showCategories && isAdmin && (
        <div style={{ position: "fixed", top: 0, left: 0, right: 0, bottom: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 1000 }}>
          <div style={{ background: "#fff", borderRadius: 12, padding: 32, maxWidth: 500, width: "90%", maxHeight: "80vh", overflowY: "auto", boxShadow: "0 10px 40px rgba(0,0,0,0.2)" }}>
            ...
            <div style={{ marginBottom: 24, padding: 16, background: "#f5f5f5", borderRadius: 8 }}>
              <h3 style={{ fontSize: 13, fontWeight: 600, color: "#1a1a1a", marginBottom: 12 }}>Add New</h3>
              <input type="text" value={newCategoryName} onChange={e => setNewCategoryName(e.target.value)} placeholder="e.g., Apparel" style={{ width: "100%", boxSizing: "border-box", padding: "10px", fontSize: 13, border: "1px solid #ddd", borderRadius: 6, marginBottom: 8, fontFamily: "inherit" }} />
            ...
            <div style={{ marginBottom: 20 }}>
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
                {categories.map(cat => (
                  <span key={cat} style={{ background: "#f5f5f5", color: "#1a1a1a", borderRadius: 6, padding: "6px 12px", fontSize: 12, fontWeight: 500 }}>{cat}</span>
                ))}
              </div>
            </div>

            <button onClick={() => setShowCategories(false)} style={{ width: "100%", padding: "10px", background: "#888", color: "#fff", border: "none", borderRadius: 6, fontSize: 13, fontWeight: 600, cursor: "pointer" }}>Close</button>
          </div>
        </div>
      )}
              ...
              <form onSubmit={handleAddOrEditProduct} style={{ display: "grid", gap: 16 }}>
                ...
                <div>
                  ...
                  <div onDragEnter={handleDrag} onDragLeave={handleDrag} onDragOver={handleDrag} onDrop={handleDrop} style={{ border: dragActive ? "2px solid #c8a96e" : "2px dashed #ddd", borderRadius: 8, padding: "20px", textAlign: "center", background: dragActive ? "#f9f7f3" : "#fafafa", cursor: "pointer" }}>
                    ...
                    <label htmlFor="imageUploadInput" style={{ cursor: "pointer" }}>Drag or click to upload</label>
                  </div>
                </div>

                <div>
                  <label style={{ display: "block", fontSize: 12, fontWeight: 600, color: "#666", marginBottom: 8 }}>Branding (pick at least 1)</label>
